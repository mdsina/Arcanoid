...
{$IFDEF FPC}
  ...
  Word16 = Word;               (* 16-bits unsigned *)
{$ENDIF}
  longint  = Integer;            (* 32 bits integer  *)
...
{$IFDEF TEST}
  ...
  procedure DivMod64by32( var X : Int64; Y : longint; var Q, R : longint );
{$ENDIF}
