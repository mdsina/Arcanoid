...
type
   ...
   public
      ...
      function CreateBody(var def: Tb2BodyDef; AutoFreeBodyDef: Boolean = True): Tb2Body;
...
begin
   ...
   {$ELSE}
      ...
      SetString(Result, Buffer, FloatToText(Buffer, extValue, TFloatFormat(fvExtended), LongInt(ffGeneral), 15));
      {$ELSE}
...
function Tb2World.CreateBody(var def: Tb2BodyDef; AutoFreeBodyDef: Boolean = True): Tb2Body;
begin
